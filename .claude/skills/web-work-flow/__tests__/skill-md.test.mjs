...
const references = [
  'A01-architecture-and-design-philosophy.md',
  'A02-protocol.md',
  'A03-shared-layer.md',
  'A04-manifest-loader-reconciliation.md',
  'A05-shadow-root-css-sync-mount.md',
  'A06-loading-skeleton-first-session.md',
  'A07-component-level-dev-proxy.md',
  'B01-how-to-add-component.md',
  'B02-large-component-layout.md',
  'B03-how-to-consume-api.md',
  'B04-stateful-ai-prompt-component.md',
  'C01-component-decision-tree.md',
  'C02-dev-server-watcher.md',
  'C03-shadow-dom-build-css-loss.md',
  'C04-fix-lint-loop.md',
  'D01-when-eslint-vs-ajv.md',
  'D02-eslint-pattern-recipes.md',
  'D03-eslint-testing-pattern.md',
  'D04-eslint-extending-existing.md',
];
