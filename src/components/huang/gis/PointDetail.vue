...
<template>
  <Teleport to="body">
    <Transition name="modal-fade">
      <div v-if="show && point" class="modal-overlay" @click.self="handleClose">
          ...
          <div class="detail-content">
            ...
            <div v-if="hasImages" class="image-viewer">
              ...
              <div class="image-navigation">
                <button @click="prevImage" class="nav-btn prev-btn" :disabled="imageCount <= 1">
                  ‹
                </button>
                <span class="image-counter">{{ currentImageIndex + 1 }} / {{ imageCount }}</span>
                <button @click="nextImage" class="nav-btn next-btn" :disabled="imageCount <= 1">
                  ›
                </button>
              </div>
            ...
            <div class="point-info">
              <h2 class="point-title">{{ point.title || '未命名地点' }}</h2>
