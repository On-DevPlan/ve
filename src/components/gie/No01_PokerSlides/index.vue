  ...
  <div class="demo-wrapper">
    <div class="container">
      <div
        ...
        :style="{ zIndex: poker.nums, transition: poker.nums === 4 ? 'none' : 'transform 0.3s ease' }"
      >
        <img :src="'/gie/No01_PokerSlides/photo (' + poker.imgIndex + ').webp'" />
      </div>
      <div
        class="poker poker5"
        :style="{ zIndex: 4, transition: 'none', background: '#fff' }"
        @click="move"
      ></div>
    </div>
  </div>
