...
.page:nth-child(3) {
  background-image: url('/gost/No36_MagazineSwitch/1.jpeg');
}
...
.page:nth-child(6) {
  background-image: url('/gost/No36_MagazineSwitch/2.jpeg');
}
...
.page:nth-child(9) {
  background-image: url('/gost/No36_MagazineSwitch/3.jpeg');
}
